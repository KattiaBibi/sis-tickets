...
var datatable;
function listar() {
    datatable = $("#empresas_areas").DataTable({
        pageLength: 5,
        destroy: true,
        async: false,
        responsive: true,
...
$("#empresas_areas").on("click", ".editar", function () {
...
$("#btnactualizar").on("click", (event) => {
    ...
    console.log(dataArray);
    let route = "/empresa_area/" + dataArray[0].value;
    dataArray.push({ name: "_token", value: token_ });
