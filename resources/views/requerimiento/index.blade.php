...
<div class="card">
  ...
  <div class="card-body">
    ...
    <table id="requerimientos" class="table table-striped table-bordered" style="overflow-x:auto;">
      <thead>
        <tr>
          <th colspan="6" class="text-center">OPCIONES</th>
          {{-- <th>ID</th> --}}
          <th>TITULO</th>
          <th>SOLICITANTE</th>
          <th>ENCARGADO(S)</th>
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEnviarRespuestaLabel">Nuevo requerimiento</h5>
...
<div class="modal fade" id="modaleditaravance" tabindex="-1" role="dialog" aria-labelledby="modalEnviarRespuestaCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEnviarRespuestaLongTitle">Editar avance</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="modalfechahora" tabindex="-1" role="dialog" aria-labelledby="modalEnviarRespuestaCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="modalEnviarRespuestaLongTitle">FECHA Y HORA PARA REQUERIMIENTO</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="modaleditar" tabindex="-1" role="dialog" aria-labelledby="modaleditarlabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">CERRAR</button>
        <button type="" id="btnactualizar" class="btn btn-primary">
          EDITAR
          <img src="https://c.tenor.com/I6kN-6X7nhAAAAAj/loading-buffering.gif" class="loader btnActualizar" style="width: 18px; display: none;">
        </button>
      </div>
      </form>
...
<div class="modal fade" id="modalEnviarRespuesta" tabindex="-1" aria-labelledby="modalEnviarRespuestaLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEnviarRespuestaLabel"><span id="textModalEnviarRpta">ENVIAR RESPUESTA</span></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="frmEnviarRpta">
          <input type="hidden" id="inputIdReqRpta">
          <input type="hidden" name="requerimiento_id" id="inputReqIdEnviarRpta">
          <div class="form-group">
            <label for="inputPdfRpta">PDF(max 5mb)*:</label>
            <div class="mb-2" id="previewPdfRpta"></div>
            <input type="file" name="pdf" id="inputPdfRpta" class="form-control-file" accept="application/pdf" data-label-validation="pdf">
            <div class="show-validation-message"></div>
          </div>
          <div class="form-group">
            <label for="descripcionRpta">Descripcion:</label>
            <textarea class="form-control" name="descripcion" id="descripcionRpta" rows="3" data-label-validation="descripcion"></textarea>
            <div class="show-validation-message"></div>
          </div>
        </form>
      </div>
      <div class="modal-footer" style="justify-content: space-between;">
        <div>
          <button type="button" class="btn btn-sm btn-danger" id="btnEliminarReqRpta" style="display: none;">
            Eliminar
            <img src="https://c.tenor.com/I6kN-6X7nhAAAAAj/loading-buffering.gif" class="loader btnEliminarReqRpta" style="width: 18px; display: none;">
          </button>
        </div>
        <div>
          <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Cerrar</button>
          <button type="submit" form="frmEnviarRpta" class="btn btn-sm btn-primary" id="btnGuardarRpta">
            Guardar
            <img src="https://c.tenor.com/I6kN-6X7nhAAAAAj/loading-buffering.gif" class="loader btnGuardarRpta" style="width: 18px; display: none;">
          </button>
        </div>
      </div>
    </div>
...
<script>
  const ID_USER_LOGUEADO = '<?= auth()->user()->id; ?>';
